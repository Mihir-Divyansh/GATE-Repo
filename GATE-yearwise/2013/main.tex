...
\fi
    ...
    \item In the circuit shown below, the knee current of the ideal Zener diode is 10 mA. To maintain 5 V
    ...
    \begin{enumerate}[label=(\Alph*)]
        ...
        \item 250 and 250
    \end{enumerate}
    \item The open-loop transfer function of a dc motor is given as frac$\frac{\omega\brak{s}}{V_a\brak{s}} = \frac{10}{1+10s}.$ When connected in
    ...
    \begin{enumerate}[label=(\Alph*)]
        ...
        \item 100
    \end{enumerate}
    \item In the circuit shown below, if the source voltage $V_S = 100\angle53.13^{\circ} V$ then the Thevenin's equivalent
    ...
    \end{enumerate}
    \item Three capacitors $C_1, C_2, \text{and} C_3$, whose values are $10\mu F, 5\mu F, \text{and} 2\mu F$ respectively, have
    ...
    \begin{enumerate}[label=(\Alph*)]
        ...
        \item 7 and 80
    \end{enumerate}
    \item A voltage $1000sin\omega t$ Volts is applied across YZ. Assuming ideal diodes, the voltage measured
    ...
    \begin{enumerate}[label=(\Alph*)]
        ...
        \item 0 for all t
    \end{enumerate}
    \item The separately excited dc motor in the figure below has a rated armature current of 20 A and a rated
    ...
    \begin{enumerate}[label=(\Alph*)]
        ...
        \item 0.7
    \end{enumerate}
    \item For a power system network with n nodes, $Z_33$ of its bus impedance matrix is j0.5 per unit. The
    ...
    \item A matrix has eigenvalues -1 and -2. The corresponding eigenvectors are $\begin{bmatrix}1\\-1\end{bmatrix}$ and $\begin{bmatrix}1\\2\end{bmatrix}$ respectively. The matrix is \hfill (2013)
    \begin{enumerate}[label=(\Alph*)]
    ...
    \begin{enumerate}[label=(\Alph*)]
        ...
        \item 2
    \end{enumerate}
    \item  In the circuit shown below, $Q_1$ has negligible collector-to-emitter saturation voltage and the diode
    ...
    \item In the circuit shown below the op-amps are ideal. Then $V_{out}$ in Volts is \hfill (2013)
    \begin{figure}[!ht]
        \centering
        \resizebox{0.4\textwidth}{!}{%
        \begin{circuitikz}

...
\textbf{Statement for Linked Answer Questions and 3 and 4}\\
...
\end{figure}
    ...
    \item The gauge pressure at section-1, in $kPa$, is  \hfill(XE-2013)
    \begin{multicols}{4}
        \begin{enumerate}
            \item 0.6
            \item 13.5
    ...
    \item The magnitude of the force, in $kN$, required to hold the pipe in place, is \hfill(XE-2013)
    \begin{multicols}{4}
        \begin{enumerate}
            \item 2.7
            \item 5.4

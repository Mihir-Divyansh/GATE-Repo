...
\begin{enumerate}
    ...
    \item $a_2 + b_1 = 0$
\end{enumerate}
\item Water \brak{density = 1000\text{kg/m}^3} at ambient temperature flows through a horizontal pipe of uniform cross-section at the rate of $1 kg/s$. If the pressure drop across the pipe is $100 kPa$, the minimum power required to pump the water across the pipe, in watts, is\underline{\hspace{2cm}} \hfill[February 2017]
...
\item A heat pump absorbs $10 kW$ of heat from outside environment at $250 K$ while absorbing $15 kW$ of work. It delivers the heat to a room that must be kept warm at $300 K$. The Coefficient of Performance \brak{COP}  of the heat pump \\is \underline{\hspace{2cm}}\hfill[February 2017]

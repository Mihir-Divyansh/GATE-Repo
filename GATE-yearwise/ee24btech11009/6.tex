...
$$x\frac{d^2y}{dx^2} + 2\brak{1-x}\frac{dy}{dx} +$$constants. Then, the arithmetic mean of $\alpha$, $\beta$, $\gamma$ is \underline{\hspace{1cm}}\brak{\text{round off to three decimal places}}.

...
\item Let $P$ be a $2 \times 2$ real orthogonal matrix and $\vec{x}$ is a real vector $\sbrak{x_1, x_2}^T$ with length $\abs{\vec{x}} = \brak{x_1^2 + x_2^2}^{1/2}$. Then, which one of the following statements is correct?  

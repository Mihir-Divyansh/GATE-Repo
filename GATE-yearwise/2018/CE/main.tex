...
\fi
    ...
    \begin{enumerate}[label=(\Alph*)]
        ...
        \item 7.5kN
    \end{enumerate}
    \item A plate in equilibrium is subjected to uniform stress along its edges with magnitude $\sigma_{xx}=30MPa$ and $\sigma_{yy}=50MPa$ as shown in the figure.
    \begin{figure}[!ht]
        \centering
        \resizebox{0.4\textwidth}{!}{%
    \begin{circuitikz}
    ...
    \begin{enumerate}[label=(\Alph*)]
        ...
        \item $120\times 10^{-6}$
    \end{enumerate}
    \item The figure shows a simply supported beam PQ of uniform flexural rigidity $EI$ carrying two
    moments M and 2M. 
    \begin{figure}[!ht]
        \centering
        \resizebox{0.4\textwidth}{!}{%

...
\fi
    ...
    \begin{table}[h]
        \centering
        \input{GATE-yearwise/2020-XE-'53-65'/tables/table1.tex}
    \end{table}
    \begin{enumerate}
    ...
    \input{GATE-yearwise/2020-XE-'53-65'/figs/fig1.tex}
    ...
    \input{GATE-yearwise/2020-XE-'53-65'/figs/fig2.tex}
    ...
    \begin{table}[h]
        \centering
        \input{GATE-yearwise/2020-XE-'53-65'/tables/table2.tex}
    \end{table}
    ...
    \begin{table}[h]
        \centering
        \input{GATE-yearwise/2020-XE-'53-65'/tables/table3.tex}
    \end{table}

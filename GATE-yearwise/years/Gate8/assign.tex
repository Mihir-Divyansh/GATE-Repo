...
%input for figure 1
\input{GATE-yearwise/years/Gate8/figs/fig1.tex}
\begin{enumerate}
    \item $\frac{1}{\pi}$
    \item $\frac{2}{\pi}$
    \item $\frac{1}{2\pi}$
...
%input for figure 2
	\input{GATE-yearwise/years/Gate8/figs/fig2.tex}
...
%input for figure 3
	\input{GATE-yearwise/years/Gate8/figs/fig3.tex}
\begin{enumerate}
    \item $188$
    \item $266$
    \item $376$
...
%input for figure 4
	\input{GATE-yearwise/years/Gate8/figs/fig4.tex}
...
%input for figure 5
	\input{GATE-yearwise/years/Gate8/figs/fig5.tex}

...
\fi
     ...
     \begin{center}
\input{ GATE-yearwise/years/2014EE/figs/43.tex}
\end{center}
...
\begin{center}
\input{ GATE-yearwise/years/2014EE/figs/54.tex}
\end{center}
...
\begin{center}
\input{ GATE-yearwise/years/2014EE/figs/55.tex}
\end{center}
...
\begin{center}
\input{ GATE-yearwise/years/2014EE/figs/57.tex}
\end{center}
...
\begin{center}
\input{ GATE-yearwise/years/2014EE/figs/Q49.tex}
\end{center}
	\begin{enumerate}
		    \begin{multicols}{2} 
	\item $\brak{V_1-V_2}$
...
\begin{center}
\input{ GATE-yearwise/years/2014EE/figs/50.tex}
\end{center}

\begin{enumerate}
       \begin{multicols}{2} 
\item    \input{GATE-yearwise/years/2014EE/figs/50a.tex}


\item    \input{ GATE-yearwise/years/2014EE/figs/50b.tex}

\item  \input{ GATE-yearwise/years/2014EE/figs/50c.tex}

\item    \input{ GATE-yearwise/years/2014EE/figs/50d.tex}
\end{multicols}  
\end{enumerate}
...
\input{ GATE-yearwise/years/2014EE/figs/51.tex}

\begin{enumerate}
   
\item    \input{ GATE-yearwise/years/2014EE/figs/51a.tex}

\item    \input{ GATE-yearwise/years/2014EE/figs/51b.tex}


\item  \input{ GATE-yearwise/years/2014EE/figs/51c.tex}


\item    \input{ GATE-yearwise/years/2014EE/figs/51d.tex}
\end{enumerate}
...
\begin{center}
\input{ GATE-yearwise/years/2014EE/figs/52.tex}
\end{center}
...
\begin{center}
\input{ GATE-yearwise/years/2014EE/figs/63.tex}
\end{center}
...
\begin{center}
\input{ GATE-yearwise/years/2014EE/figs/54f1.tex}
Figure(i)
\end{center}

\begin{center}
\input{ GATE-yearwise/years/2014EE/figs/54f2.tex}
Figure(ii)
\end{center}
...
\begin{center}
\input{ GATE-yearwise/years/2014EE/figs/65.tex}
\end{center}

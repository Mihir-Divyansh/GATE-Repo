...
\begin{tikzpicture}
    % Axes and labels
    \draw[->] (0,0) -- (13,0) node[right] {Calendar Year};
    \draw[->] (0,0) -- (0,8) node[above] {Batting Average};
    
    % Horizontal grid lines and y-axis labels
    \foreach \y in {1,2,...,7} {
        \draw[dashed, gray] (0,\y) -- (13,\y);
        \node[left] at (0,\y) {\y0};
    }
    
    % x-axis labels
    \foreach \x/\label in {1/2012, 2/2013, 3/2014, 4/2015, 5/2016, 
                           6/2017, 7/2018, 8/2019, 9/2020, 10/2021, 11/2022} {
        \node[below] at (\x,0) {\label};
    }
    
    % Bars for VK
    \foreach \x/\y in {1/6, 2/5, 3/5, 4/3, 5/10, 
                       6/6, 7/14, 8/6, 9/5, 10/2, 11/4} {
        \fill[gray!70] (\x-0.25,0) rectangle (\x-0.05,\y);
    }
    
    % Bars for RS
    \foreach \x/\y in {1/1, 2/5, 3/5, 4/4, 5/3, 
                       6/7, 7/8, 8/6, 9/6, 10/4, 11/5} {
        \fill[black!40] (\x+0.05,0) rectangle (\x+0.25,\y);
    }
    
    % Legend
    \node[draw,fill=white,align=left] at (11,7.5) {
        \begin{tikzpicture}[scale=0.5]
            \fill[gray!70] (0,0) rectangle (0.3,0.3);
            \node[right] at (0.4,0.15) {VK};
            
            \fill[black!40] (2,0) rectangle (2.3,0.3);
            \node[right] at (2.4,0.15) {RS};
        \end{tikzpicture}
    };
\end{tikzpicture}
}

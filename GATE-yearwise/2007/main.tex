...
\begin{enumerate}
    ...
    \item $0.4 \Bar{c}$\\ 
\end{enumerate}
\textbf{Common Data for Questions $74 \& 75$:} Consider the spring mass system shown in figure below. This system mass system shown in figure below. This system has two degrees of freedom representing the motions of the two masses. 

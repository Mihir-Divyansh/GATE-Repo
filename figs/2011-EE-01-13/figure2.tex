...
\draw [line width=0.7pt, short] (6.25,16.5) -- (8.5,16.5);
\draw [line width=0.7pt, short] (11,11.5) -- (13.25,11.5);
\draw [line width=0.5pt, ->, >=Stealth] (11,13.5) -- (13.25,13.5);
\draw [line width=0.5pt, ->, >=Stealth] (9.25,16.75) -- (9.25,17);
\node [font=\Large] at (9,17) {$V_o$};
\node [font=\Large] at (12,13) {$V_1$};
\draw [line width=0.5pt, dashed] (8.5,16.5) -- (9.75,16.5);
\draw [line width=0.7pt, short] (11,11.5) -- (8.5,16.5);
\draw [line width=0.5pt, dashed] (11,11.5) -- (11,14);
\draw [line width=0.5pt, dashed] (9.75,11.5) -- (11,11.5);
\node [font=\Large] at (10.5,17) {+12V};
\node [font=\Large] at (11.75,14.25) {+6V};
\node [font=\Large] at (9,11.5) {-12V};
\node [font=\Large] at (8.5,13.5) {-6V};
\end{circuitikz}
}%
